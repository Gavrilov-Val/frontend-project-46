...
const getDataType = filepath => path.extname(filepath).replace('.', '').toLowerCase()
...
const showDiff = (filepath1, filepath2, formatName = 'stylish') => {
  ...
  const parsedData1 = parseFile(data1, dataType1)
  const parsedData2 = parseFile(data2, dataType2)
